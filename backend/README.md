...
## Project Structure
    ...
    ├── fellowship_social_35406  # Django project configurations
...
1. Clone this repo and `cd fellowship_social_35406`
...
2. Clone this repo and `cd fellowship_social_35406`
